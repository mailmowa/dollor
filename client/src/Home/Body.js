            ...
            <div className="body_div">
                <div className="row m-0 p-0">
                    <div className="body_Content col-md-6 ">
                          <h1 className="display-4" style={{textTransform:"uppercase"}} >Best Crowd Funding platform with huge profits</h1>
                  ...
                  <div class="container py-5">
                    ...
                    <div class="row align-items-center">
                      <div class="col-lg-5 px-5 mx-auto">
                        <img src={process.env.PUBLIC_URL + '/Bp.png'} alt="" class="img-fluid mb-4 mb-lg-0"/>
                        </div>
                      <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                        <h2 class="font-weight-light" style={{color:"lightblue"}}>Lorem ipsum dolor sit amet</h2>
                        <p class="font-italic text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
