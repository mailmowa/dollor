                                ...
                                {    
                                            if(user1)
                                            {
                                                      ...
                                                      .then(  (updated) => {
                                                                  ...
                                                                  if(updated){
                                                                          console.log("in Updated: Daily Report+++++++++++++++++++")
                                                                          createAutopool(user1)
                                                                          handleActivateUser(user1.referedBy,user1.userId);
                                                                    ...
                                                                    report.save()
                                                                    .then(re => {
                                                                      console.log("in Save: Daily Report+++++++++++++++++++")
                                                                            ...
                                                                            if(updated){
                                                                              console.log("daily report updated **************************************");
                                                                                      ...
                                                                                      //   Others
                                                                                        ...
                                                                                        report.save()
                                                                                        .then(re => {
                                                                                          console.log("daily reported created **************************************",re);
                                                                                          createAutopool(user)
                                                                                          handleActivateUser(user.referedBy,user.userId);
                                                                                          res.json({status: 1 , user1 })
                                                                                        }).catch(re => {
                                                                                          console.log("error catched at daily report created **************************************",re);
                                                                                            res.json({status : 0})
                                                                                        })
                                                                                        console.log("created");
                  ...
                  while (ReferedBy1 && i<10) {
                                ...
                                if(i===0){ 
                                            await User.find(
                                                ...
                                                console.log(userqwe,":  User.levelTeam.length---1111")
                                              if(userqwe.length > 0){
                                                  console.log(userqwe[0].levelTeam.length,":  User.levelTeam.length")
                                                                      ...
                                                                      $push : { levelTeam : user2 }
                                                                              ...
                                                                              if(user321){
                                                                                              await dailyReport.findOneAndUpdate({
                                                                                                  ...
                                                                                                  $inc : {  LevelOutSpend : parseFloat(15) }
                                                                                                })
                                                                                                .then(re => {
                                                                      ...
                                                                      $push : { levelTeam : user2 }
                                                                              ...
                                                                              if(user123){
                                                                                              await dailyReport.findOneAndUpdate({
                                                                                                  ...
                                                                                                  $inc : {  LevelOutSpend : parseFloat(10) }
                                                                                                })
                                                                                                .then(re => {
                                                                                                  console.log("error catched at in and as was created **************************************");
                                                                                                  console.log(" ")})
                                                                        ...
                                                                        console.log("error catched at user if handle Active user **************************************",err);
                                                                           // res.json({status: 0});
                                                                      })
                                                                    console.log("line: 109",ReferedBy1);
                                                          }
                                              }
                                              else{
                                                            ReferedBy1 = ""
                                                  ...
                                                  ReferedBy1 = ""
                                                  console.log("error catched at user if handle Active user line 11 **************************************");
                                                      res.json({status: 0});
                                                })
                                              console.log("line: 11",ReferedBy1);
                                    ...
                                    $inc: { levelIncome : parseFloat(1) ,Totalearnings: parseFloat(1)  }
                                              ...
                                              if(user){
                                                        ...
                                                        dateId : today
                                                            ...
                                                            $inc : {  LevelOutSpend : parseFloat(1) }
                                                        })
                                                        .then(re => 
...
catch(err)
{
 ...
 router.post('/Royaltyupdate', (req,res) => {
...
try{
  ...
  User.findByIdAndUpdate(
   ...
   {
      $inc: {
               Royaltyamount: -parseFloat(req.body.Sendamount),
               fundSharingIncome: parseFloat(req.body.Sendamount)
            }
    ...
    res.json({status: 0 , user})
    console.log(err  ," : Error in Royatyyyyy----------------==================------------===========-------");
  })
